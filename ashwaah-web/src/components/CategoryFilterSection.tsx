...
export default function CategoryFilterSection({
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full items-stretch relative z-30">
      ...
      <div className="lg:hidden w-full sticky top-14 z-40 bg-brand-light/95 backdrop-blur-sm py-2 px-1 mb-2">
        <button
      ...
      <aside
        className={`w-full lg:w-60 flex-shrink-0 bg-[#FFFDF6] border-r border-brand/10 p-4 lg:px-4 lg:py-6 rounded-none lg:sticky lg:top-14 lg:h-[calc(100vh-56px)] lg:overflow-y-auto custom-scrollbar lg:block ${
